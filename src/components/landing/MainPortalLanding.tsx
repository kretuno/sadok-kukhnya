...
export const MainPortalLanding: React.FC<MainPortalLandingProps> = ({ onSelectRole }) => {
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 flex flex-col selection:bg-blue-600 selection:text-white relative overflow-x-hidden font-sans">
      {/* Background Ambient Glow Lights */}
      <div className="absolute top-0 left-1/4 -translate-x-1/2 w-[500px] h-[500px] bg-amber-500/10 rounded-full blur-[140px] pointer-events-none" />
      <div className="absolute top-12 left-1/2 -translate-x-1/2 w-[650px] h-[500px] bg-indigo-600/15 rounded-full blur-[160px] pointer-events-none" />
      <div className="absolute top-0 right-1/4 translate-x-1/2 w-[500px] h-[500px] bg-emerald-500/10 rounded-full blur-[140px] pointer-events-none" />

      {/* Top Header Bar */}
      <header className="border-b border-slate-800/80 bg-slate-900/60 backdrop-blur-md sticky top-0 z-30 px-4 sm:px-8 py-3">
        <div className="max-w-7xl mx-auto flex items-center justify-between gap-4">
          ...
          <div className="flex items-center space-x-3 sm:space-x-4">
            ...
            <div className="flex items-center space-x-1.5 px-2.5 py-1 rounded-full bg-emerald-950/60 border border-emerald-500/40 text-emerald-300 text-[11px] font-semibold">
      ...
      <section className="relative z-10 max-w-5xl mx-auto text-center px-4 sm:px-6 pt-10 pb-6 sm:pt-14 sm:pb-10">
        <div className="inline-flex items-center space-x-2 px-3.5 py-1.5 rounded-full bg-slate-800/90 border border-slate-700 shadow-sm text-xs text-amber-300 font-bold mb-4">
      ...
      <main className="relative z-10 max-w-7xl mx-auto w-full px-4 sm:px-6 pb-12 flex-1 flex flex-col justify-center">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 sm:gap-8 items-stretch">
          ...
          <div className="group relative flex flex-col justify-between rounded-3xl p-6 sm:p-7 bg-gradient-to-b from-amber-500/10 via-slate-900/90 to-slate-900/95 border border-amber-500/30 hover:border-amber-400/80 shadow-xl hover:shadow-2xl hover:shadow-amber-500/10 hover:-translate-y-1.5 transition-all duration-300">
            ...
            <div className="space-y-5 relative z-10">
              ...
              <div className="flex items-center justify-between">
                ...
                <span className="px-3 py-1 rounded-full bg-amber-500/20 border border-amber-400/40 text-amber-300 text-xs font-extrabold flex items-center gap-1.5">
              ...
              <div>
                ...
                <h2 className="text-2xl font-black text-white mt-1 group-hover:text-amber-200 transition">
            ...
            <div className="pt-6 relative z-10">
              <button
                ...
                className="w-full py-3.5 px-5 rounded-2xl bg-gradient-to-r from-amber-500 to-orange-500 hover:from-amber-400 hover:to-orange-400 text-white font-extrabold text-sm shadow-lg shadow-orange-500/25 flex items-center justify-center space-x-2 transition-all transform active:scale-95 cursor-pointer"
              >
                <span>Увійти в кабінет батьків</span>
                <ArrowRight className="w-4 h-4 group-hover:translate-x-1 transition" />
              </button>
              <span className="block text-center text-[11px] text-amber-300/80 mt-2 font-medium">
          ...
          <div className="group relative flex flex-col justify-between rounded-3xl p-6 sm:p-7 bg-gradient-to-b from-indigo-600/20 via-slate-900/90 to-slate-900/95 border-2 border-indigo-500/50 hover:border-indigo-400 shadow-2xl hover:shadow-indigo-500/20 hover:-translate-y-2 transition-all duration-300">
            {/* Crown Top Ribbon */}
            ...
            <div className="space-y-5 relative z-10 pt-2">
              ...
              <div className="flex items-center justify-between">
                ...
                <span className="px-3 py-1 rounded-full bg-indigo-500/20 border border-indigo-400/40 text-indigo-300 text-xs font-extrabold flex items-center gap-1.5">
              ...
              <div>
                ...
                <h2 className="text-2xl font-black text-white mt-1 group-hover:text-indigo-200 transition">
                  Кабінет керівника
                </h2>
                <p className="text-xs sm:text-sm text-slate-300 mt-2 line-clamp-2">
            ...
            <div className="pt-6 relative z-10">
              ...
              <span className="block text-center text-[11px] text-indigo-300/80 mt-2 font-medium">
                PIN-код за замовчуванням: <strong className="text-amber-300 font-mono">145</strong> (можна змінити)
              </span>
            </div>
          </div>

          {/* CARD 3: УПРАВЛІННЯ ТА ПЕРСОНАЛ */}
          <div className="group relative flex flex-col justify-between rounded-3xl p-6 sm:p-7 bg-gradient-to-b from-emerald-600/10 via-slate-900/90 to-slate-900/95 border border-emerald-500/30 hover:border-emerald-400/80 shadow-xl hover:shadow-2xl hover:shadow-emerald-500/10 hover:-translate-y-1.5 transition-all duration-300">
            {/* Top Glow Accent */}
            ...
            <div className="space-y-5 relative z-10">
              ...
              <div>
                ...
                <h2 className="text-2xl font-black text-white mt-1 group-hover:text-emerald-200 transition">
            ...
            <div className="pt-6 relative z-10">
              <button
                ...
                className="w-full py-3.5 px-5 rounded-2xl bg-gradient-to-r from-emerald-600 to-teal-600 hover:from-emerald-500 hover:to-teal-500 text-white font-extrabold text-sm shadow-lg shadow-emerald-600/25 flex items-center justify-center space-x-2 transition-all transform active:scale-95 cursor-pointer"
              >
                <Lock className="w-4 h-4" />
                <span>Вхід для співробітників</span>
                <ChevronRight className="w-4 h-4 group-hover:translate-x-1 transition" />
              </button>
              <span className="block text-center text-[11px] text-emerald-300/80 mt-2 font-medium">
                PIN-код за замовчуванням: <strong className="text-amber-300 font-mono">145</strong> (можна змінити)
              </span>
            </div>
          </div>
        ...
        <div className="mt-10 grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="p-4 rounded-2xl bg-slate-900/60 border border-slate-800/80 flex items-center space-x-3.5">
            ...
            <div>
              <span className="text-xs font-bold text-white block">100% Конфіденційність</span>
              <span className="text-[11px] text-slate-400">Локальне зберігання без передачі третім особам</span>
            </div>
          </div>
          ...
          <div className="p-4 rounded-2xl bg-slate-900/60 border border-slate-800/80 flex items-center space-x-3.5">
            ...
            <div>
              <span className="text-xs font-bold text-white block">Повна автономність</span>
              <span className="text-[11px] text-slate-400">Працює стабільно навіть без доступу до інтернету</span>
            </div>
          </div>
          ...
          <div className="p-4 rounded-2xl bg-slate-900/60 border border-slate-800/80 flex items-center space-x-3.5">
            ...
            <div>
              <span className="text-xs font-bold text-white block">Стандарти МОН та МОЗ</span>
              <span className="text-[11px] text-slate-400">Відповідність нормам КМУ №305 та СанПіН</span>
            </div>
          </div>
        </div>
      </main>
      ...
      {/* Footer */}
      <footer className="border-t border-slate-800/80 bg-slate-900/80 text-slate-400 text-xs py-5 px-4 sm:px-8 mt-auto relative z-10">
        <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-3">
          <div className="flex items-center space-x-2">
            <span className="font-bold text-slate-300">КЗДО №145 КМР «Півник»</span>
            <span>•</span>
            <span className="text-slate-400">м. Кривий Ріг</span>
          </div>

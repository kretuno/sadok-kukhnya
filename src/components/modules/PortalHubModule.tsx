...
export const PortalHubModule: React.FC<PortalHubModuleProps> = ({ onSelectModule, portalRole }) => {
  ...
  const projects: ProjectModuleItem[] = [
    ...
    },
    {
      ...
      icon: BarChart3,
      status: 'active',
      description: 'Зведена аналітична та фінансова звітність для Департаменту освіти, оборотно-сальдова відомість (ОСВ) та вартість діто-дня.',
      features: [
        'Оборотно-сальдова відомість матеріальних цінностей (ОСВ)',
        'Аналітика виконання грошових норм харчування та діто-дня',
        'Відомість витрат продуктів по категоріях харчування',
        'Реєстр прибуткових накладних постачальників за період'
      ]
    }
  ];
